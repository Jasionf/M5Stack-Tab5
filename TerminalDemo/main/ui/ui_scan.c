...
bool g_p2_is_bt = false;   

static lv_obj_t   *s_panel    = NULL;   
static lv_color_t  s_accent;            
static bool        s_page_is_bt;        
static lv_obj_t   *s_scr2     = NULL;   

static lv_obj_t   *s_scan_row     = NULL;   
static lv_obj_t   *s_prog_bg      = NULL;   
static lv_obj_t   *s_heading_lbl  = NULL;   
...
static void refresh_btn_click_cb(lv_event_t *e)
{
    ...
    lv_async_call(refresh_node_list, NULL);   
...
void build_page2(bool is_bt)
{
    ...
    lv_obj_set_style_clip_corner(prog_bg, true, 0); 
